package com.example.daysmatter.ui.sharewm;
...
public class SharewmFragment extends Fragment {
    ...
    public View course(View cFragment){
        ...
        Cursor cursor = db.query("share",new String[]{"rid","title","dsc","tim"},null,null,null,null,"tim");
